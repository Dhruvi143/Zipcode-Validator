...
class Upload extends \Magento\Backend\App\Action
{
     ...
     * @param \Codilar\Zipcode\Model\Zipcode\FileUploader $fileUploader
     */
    ...
    {
        return $this->_authorization->isAllowed('Codilar_Zipcode::zipcode_read') ||
            $this->_authorization->isAllowed('Codilar_Zipcode::zipcode_create');
    }
