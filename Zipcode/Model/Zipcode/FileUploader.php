<?php
namespace Codilar\Zipcode\Model\Zipcode;

use Codilar\Zipcode\Model\Zipcode\FileInfo;
use Magento\Framework\App\ObjectManager;

/**
 * Zipcode image uploader
 */
class FileUploader
{
    /**
    ...
    public function __construct(
        ...
        $baseTmpPath = 'Codilar/tmp/zipcode',
        $basePath = 'Codilar/zipcode',
    ...
    public function moveFileFromTmp($fileName)
    {
        ...
        try {
            if ($this->getFileInfo()->isExist($fileName, $this->baseTmpPath)) {
